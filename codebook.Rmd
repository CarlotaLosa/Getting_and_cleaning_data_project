...
This is the codebook describing the variables of the tidy data set

The tidy data set contains 81 columns (variables) and 180 rows (observations)

## Column structure

* Column 1: Subject number (from 1 to 30 as there were 30 subjects in total)

* Column 2: Activity label - "LAYING", "SITTING", "STANDING", "WALKING", "WALKING_DOWNSTAIRS", "WALKING_UPSTAIRS"

* Columns 3 to 81: the different variables that were measured in the experiment. Hopefully the names are descriptive enought
